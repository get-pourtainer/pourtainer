...
export interface paths {
    ...
    "/edge_groups/{id}": {
         ...
         * @description **Access policy**: administrator
         */
        put: operations["EdgeGroupUpdate"];
        post?: never;
        /**
    ...
    "/endpoints/{id}/docker/v1.41/images/create": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/endpoints/{id}/docker/v2/browse/delete": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post?: never;
        /**
         * Delete a file under a specific path on the file system of an environment (endpoint)
         * @description Use this environment(endpoint) to delete a file.
         *     **Access policy**: administrator
         */
        delete: {
            parameters: {
    ...
    "/endpoints/{id}/docker/v2/browse/ls": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get the contents of a path (endpoint)
         * @description Use this environment(endpoint) to get contents of a path.
         */
        get: {
            parameters: {
                query: {
    ...
    "/endpoints/{id}/docker/v2/browse/rename": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /**
         * Rename a file under a specific path on the file system of an environment (endpoint)
         * @description Use this environment(endpoint) to rename a file.
         *     **Access policy**: administrator
         */
        put: {
            parameters: {
    ...
    "/kubernetes/{id}/describe": {
         ...
         *     **Access policy**: Authenticated user.
         */
        get: operations["DescribeResource"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/kubernetes/{id}/events": {
         ...
         *     **Access policy**: Authenticated user.
         */
        get: operations["getAllKubernetesEvents"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/kubernetes/{id}/namespaces/{namespace}/events": {
         ...
         *     **Access policy**: Authenticated user.
         */
        get: operations["getKubernetesEventsForNamespace"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        "kubernetes.K8sApplication": {
            ...
            CreationDate?: string;
            CustomResourceMetadata?: components["schemas"]["kubernetes.CustomResourceMetadata"];
        ...
        "kubernetes.K8sEvent": {
            ...
            involvedObject?: components["schemas"]["kubernetes.K8sEventInvolvedObject"];
            kind?: string;
        ...
        "release.Dependency": {
            ...
            "import-values"?: Record<string, never>[];
        ...
        "release.Info": {
            ...
            resources?: components["schemas"]["unstructured.Unstructured"][];
        ...
        "release.Release": {
            ...
            info?: components["schemas"]["release.Info"];
            ...
            namespace?: string;
            values?: components["schemas"]["release.Values"];
...
export interface operations {
    ...
    EdgeJobCreateString: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["edgejobs.edgeJobCreateFromFileContentPayload"];
            };
        };
        responses: {
            /** @description OK */
    ...
    EdgeStackCreateRepository: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["edgestacks.edgeStackFromGitRepositoryPayload"];
            };
        };
        responses: {
            /** @description OK */
    ...
    EdgeStackCreateString: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["edgestacks.edgeStackFromStringPayload"];
            };
        };
        responses: {
            /** @description OK */
    ...
    EndpointList: {
        parameters: {
            query?: {
                ...
                /** @description if true, the SnapshotRaw field won't be retrieved */
    ...
    HelmGetHistory: {
        ...
        responses: {
            ...
            /** @description Server error occurred while attempting to retrieve the historical list of releases. */
            500: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    HelmRollback: {
        ...
        responses: {
            ...
            /** @description Unable to find an environment with the specified identifier or release name. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    GitOperationRepoFilePreview: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["gitops.repositoryFilePreviewPayload"];
            };
        };
        responses: {
            /** @description Success */
    ...
    DescribeResource: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["kubernetes.describeResourceResponse"];
                };
            };
            /** @description Invalid request payload, such as missing required fields or fields not meeting validation criteria. */
            400: {
    ...
    getAllKubernetesEvents: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["kubernetes.K8sEvent"][];
                };
            };
            /** @description Invalid request payload, such as missing required fields or fields not meeting validation criteria. */
            400: {
    ...
    getKubernetesEventsForNamespace: {
        parameters: {
            query?: {
                /** @description The resource id of the involved kubernetes object */
                resourceId?: string;
        ...
        responses: {
            ...
            /** @description Server error occurred while attempting to retrieve the events within the specified namespace. */
            500: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    StackMigrate: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["stacks.stackMigratePayload"];
            };
        };
        responses: {
            /** @description Success */
    ...
    StackCreateKubernetesGit: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["stacks.kubernetesGitDeploymentPayload"];
            };
        };
        responses: {
            /** @description OK */
    ...
    StackCreateKubernetesFile: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["stacks.kubernetesStringDeploymentPayload"];
            };
        };
        responses: {
            /** @description OK */
    ...
    StackCreateKubernetesUrl: {
        ...
        requestBody: {
            content: {
                "*/*": components["schemas"]["stacks.kubernetesManifestURLDeploymentPayload"];
            };
        };
        responses: {
            /** @description OK */
